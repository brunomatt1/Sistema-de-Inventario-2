...
<div class="container pb-4 pt-6">
	...
	<div class="form-rest mb-3 mt-3"></div>
	...
	<form action="./php/usuario_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Usuario</label>
				  	<input placeholder="Solo minúsculas y números" class="input" type="text" name="usuario_usuario" pattern="[a-z0-9_.]{4,20}" maxlength="20" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
