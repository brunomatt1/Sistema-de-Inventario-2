<nav class="navbar" role="navigation" aria-label="main navigation">
    ...
    <div class="navbar-brand">
        ...
        <img src="./img/logo.jpg" width="44" height="14">
        </a>
        ...
        <div class="navbar-end">
            <div class="navbar-item">
                ...
                Mi cuenta
                    ...
                    <a href="index.php?vista=logout" onclick="return confirm('¿Estás seguro que deseas cerrar la sesión?');" class="button is-link is-rounded">
                    Salir
                    </a>
                    </div>
            </div>
